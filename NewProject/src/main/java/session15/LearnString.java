...
public static void main(String[] args) {
	...
	public static void stringAddress(){
		...
		String a1 = new String("training");
		String b1 = new String("training1");
	...
	public static void stringBufferAddress(){
		...
		String a = "training"; // literal
		//String comp = new String("training"); // object of class
		...
		StringBuffer b = new StringBuffer("training");
		System.out.println("Memory address of b: "+ System.identityHashCode(b));
	...
	public static void checkLiteral(){
		...
		String c = new String("training");
		String d = new String("training1");
